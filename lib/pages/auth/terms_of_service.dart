    ...
    return Scaffold(
      ...
      body:SafeArea(child: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              Text('In the course of engaging with our services, you provide personal information about you.'),
              SizedBox(height: 20.0,),
              Text(''' Ensuring your privacy is important to us. We don’t share your personal information with anyone expect as described in the privacy policy. we may share your personal information with;'''),
              ...
              Row(children: [
                Text('C . '),
                Expanded(child: Text('Affiliated companies within our corporate structure'))
              ],),
              Row(children: [
                Text('D . '),
              ...
              SizedBox(height: 20.0,),
              Text(''' All the categories mentioned above have access to personal information only as needed to perform their functions and must process the personal information in accordance with the privacy policy'''),
              SizedBox(height: 20.0,),
